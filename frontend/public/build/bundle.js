...
var app = (function () {
    ...
    /* src\Tailwindcss.svelte generated by Svelte v3.29.4 */
    ...
    function ajax(endpoint, {body, ...config} = {}) {
        const headers = {
    ...
    /* src\components\Loader.svelte generated by Svelte v3.29.4 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "circle svelte-lb819g");
    			set_style(div, "--size", /*size*/ ctx[0] + /*unit*/ ctx[2]);
    			set_style(div, "--color", /*color*/ ctx[1]);
    			add_location(div, file$2, 26, 2, 558);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "rounded border p-1 max-w-xs mx-auto my-2 bg-blue-500 text-white");
    			add_location(button, file$3, 53, 8, 1725);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "rounded border p-2 max-w-xs mx-auto my-2");
    			add_location(input0, file$3, 42, 8, 1085);
    			attr_dev(input1, "type", "text");
    			input1.required = true;
    			attr_dev(input1, "placeholder", "Last Name");
    			attr_dev(input1, "class", "rounded border p-2 max-w-xs mx-auto my-2");
    			add_location(input1, file$3, 44, 8, 1234);
    			attr_dev(input2, "type", "email");
    			input2.required = true;
    			attr_dev(input2, "placeholder", "email");
    			attr_dev(input2, "class", "rounded border p-2 max-w-xs mx-auto my-2");
    			add_location(input2, file$3, 46, 8, 1381);
    			attr_dev(input3, "type", "text");
    			input3.required = true;
    			attr_dev(input3, "placeholder", "phone");
    			attr_dev(input3, "class", "rounded border p-2 max-w-xs mx-auto my-2");
    			add_location(input3, file$3, 48, 8, 1521);
    			attr_dev(form, "class", "border flex flex-col justify-center max-w-sm bg-gray-100 mx-auto w-full p-3");
    			add_location(form, file$3, 39, 4, 927);
    			attr_dev(div, "class", "min-h-screen flex items-center");
    			add_location(div, file$3, 38, 0, 877);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input3, /*phone*/ ctx[1]);
    			append_dev(form, t3);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*phone*/ 2 && input3.value !== /*phone*/ ctx[1]) {
    				set_input_value(input3, /*phone*/ ctx[1]);
    			}
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("U5Bcontactu5D", slots, []);
    	let { contact } = $$props;
    	let email;
    	let phone;
    	let firstName;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<U5Bcontactu5D> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		if ("contact" in $$props) $$invalidate(6, contact = $$props.contact);
    	};
    ...
    class U5Bcontactu5D extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { contact: 6 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "U5Bcontactu5D",
    			options,
    			id: create_fragment$5.name
    		});
    		...
    		if (/*contact*/ ctx[6] === undefined && !("contact" in props)) {
    			console_1.warn("<U5Bcontactu5D> was created without expected prop 'contact'");
    		}
    	}

    	get contact() {
    		throw new Error("<U5Bcontactu5D>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set contact(value) {
    		throw new Error("<U5Bcontactu5D>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "rounded border p-1 max-w-xs mx-auto my-2 bg-blue-500 text-white");
    			add_location(button, file$4, 37, 8, 1166);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "rounded border p-2 max-w-xs mx-auto my-2");
    			add_location(input0, file$4, 30, 8, 812);
    			attr_dev(input1, "type", "password");
    			input1.required = true;
    			attr_dev(input1, "placeholder", "password");
    			attr_dev(input1, "class", "rounded border p-2 max-w-xs mx-auto my-2");
    			add_location(input1, file$4, 32, 8, 952);
    			attr_dev(form, "class", "border flex flex-col justify-center max-w-sm bg-gray-100 mx-auto w-full p-3");
    			add_location(form, file$4, 27, 4, 654);
    			attr_dev(div, "class", "min-h-screen flex items-center");
    			add_location(div, file$4, 26, 0, 604);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*handleForm*/ ctx[3]), false, true, false)
    				];
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	function handleForm() {
    		...
    		ajax("login", { body: { email, password } }).then(response => {
    			localStorage.setItem("login-token", response.token);
    			checkLogin();
    		}).finally(() => {
    	...
    	const writable_props = ["checkLogin"];
    	...
    	$$self.$$set = $$props => {
    		if ("checkLogin" in $$props) $$invalidate(4, checkLogin = $$props.checkLogin);
    	};
    ...
    class Login extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { checkLogin: 4 });
    		...
    		if (/*checkLogin*/ ctx[4] === undefined && !("checkLogin" in props)) {
    			console.warn("<Login> was created without expected prop 'checkLogin'");
    		}
    	}
    ...
    function create_if_block_1$1(ctx) {
    	...
    	login = new Login({
    			props: { checkLogin: /*checkLogin*/ ctx[2] },
    			$$inline: true
    		});
    ...
    // (28:4) {#each contacts as contact}
    function create_each_block$2(ctx) {
    	let li;
    	let a;
    	let span0;
    	let t0_value = /*contact*/ ctx[4].firstName + " " + /*contact*/ ctx[4].lastName + "";
    	let t0;
    	let t1;
    	let span1;
    	let t2_value = /*contact*/ ctx[4].phone + "";
    	let t2;
    	let t3;
    	let span2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			attr_dev(span0, "class", "leading-4 ");
    			add_location(span0, file$5, 30, 16, 875);
    			attr_dev(span1, "class", "leading-4 text-gray-800");
    			add_location(span1, file$5, 31, 16, 974);
    			attr_dev(span2, "class", "leading-4 text-gray-800");
    			add_location(span2, file$5, 32, 16, 1056);
    			attr_dev(a, "class", "flex flex-col border p-2 cursor-pointer");
    			attr_dev(a, "href", a_href_value = /*contact*/ ctx[4]._id);
    			add_location(a, file$5, 29, 12, 787);
    			add_location(li, file$5, 28, 8, 769);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*contacts*/ 2 && t0_value !== (t0_value = /*contact*/ ctx[4].firstName + " " + /*contact*/ ctx[4].lastName + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*contacts*/ 2 && t2_value !== (t2_value = /*contact*/ ctx[4].phone + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*contacts*/ 2 && t4_value !== (t4_value = /*contact*/ ctx[4].email + "")) set_data_dev(t4, t4_value);

    			if (dirty & /*contacts*/ 2 && a_href_value !== (a_href_value = /*contact*/ ctx[4]._id)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(28:4) {#each contacts as contact}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	let if_block1 = /*loading*/ ctx[3] && create_if_block$4(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block1) if_block1.c();
    			if_block1_anchor = empty();
    			attr_dev(ul, "class", "border w-full max-w-sm mx-auto");
    			add_location(ul, file$5, 26, 0, 683);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	function checkLogin() {
    		$$invalidate(0, loggedIn = !!localStorage.getItem("login-token"));

    		if (loggedIn) ajax("contact").then(response => {
    			$$invalidate(1, contacts = response);
    		});
    	}
    	...
    	return [loggedIn, contacts, checkLogin, loading];
    }
      ...
      "children": [
        {
          ...
          "ext": "svelte",
          "badExt": false,
          "absolutePath": "C:/Users/MAXIMILIANO ROBLES/Desktop/TBLTECHNERDS Final Exam (JS Developers)/contacts list/frontend/src/pages/[contact].svelte",
        ...
        },
        {
          ...
          "ext": "svelte",
          "badExt": false,
          "absolutePath": "C:/Users/MAXIMILIANO ROBLES/Desktop/TBLTECHNERDS Final Exam (JS Developers)/contacts list/frontend/src/pages/index.svelte",
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Tailwindcss, Router, routes: routes$1 });
    	return [];
    }
